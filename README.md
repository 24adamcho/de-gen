...
`defaultTitles`? | bool | Enables or disables default titles. Default: `false`. Defining a new section with the same key (see Section) take precedence over default definitions.
